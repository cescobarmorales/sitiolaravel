...
<nav class="bg-[#0369a1] py-4 px-4" x-data="{open : false}">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:block sm:ml-6">
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-3 pt-1 border-b-2 border-[#1e3a8a]
                 text-sm font-medium leading-5 text-white focus:outline-none focus:border-[#0369a1] transition" aria-current="page">Venta</a>

                <a href="{{ route('productos') }}" class="inline-flex items-center px-3 pt-1 border-b-2 border-[#1e3a8a]
                 text-sm font-medium leading-5 text-white focus:outline-none focus:border-[#0369a1] transition" aria-current="page">Registro</a>
        ...
        @else
            <div>
                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Ingresar</a>
        
                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Registrarse</a>
            </div>  
        @endauth
